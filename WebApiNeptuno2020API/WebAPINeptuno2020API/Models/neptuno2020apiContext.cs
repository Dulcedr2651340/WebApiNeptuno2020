...
{
    public partial class neptuno2020apiContext : DbContext
    {
        public neptuno2020apiContext()
        {
        }

        public neptuno2020apiContext(DbContextOptions<neptuno2020apiContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<pa_pedidos_empleado> Pa_Pedidos_Empleado { get; set;}
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=localhost\\SQLEXPRESS;Initial Catalog=neptuno2020api;trusted_connection=yes;");
            }
        }
